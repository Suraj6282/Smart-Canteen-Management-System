...
const AdminHome = (props) => {
  ...
  const [date, setDOE] = useState(null);
                ...
                <div>
                  ...
                  <fieldset>
                    ...
                    <div className="row p-3">
                      <div className="col p-2">
                        <Card
                          title="Todays Lunch  (Items for the Day)"
                          textColor="#293462"
                          background="#F2EBE9"
                        >
                          <Button
                      ...
                      <div className="col p-2">
                        <Card
                          title="UpComing dishes(Best Of With Offers)"
                          textColor="#293462"
                          background="#F2EBE9"
                        >
                          <Button
                    ...
                    <fieldset>
                      ...
                      <div className="row p-3">
                        <div className="col-12">
                          <Card
                            title="Please fill Student Details"
                            textColor="#000"
                          >
                              ...
                              <div className="row p-2">
                                <div className="col-6">
                                  <Input
                                    ...
                                    placeholder="Enter start pass date"
                                    onKeyUp={onDOBInput}
                                  />
                                </div>
                                ...
                                <div className="col-6">
                                  <Input
                                    // type="date"
                                    placeholder="Enter end pass date"
                                    onKeyUp={onDOEInput}
                                  />
                                </div>
                                  ...
                                  <div className="col-4 p-2" key={employee.id}>
                                    ...
                                    >
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          window.alert("All details deleted");
                                        }}
                                      >
                                        Delete
                                      </button>
                  ...
                  {feature === "SEARCH_EMP" && (
                    <fieldset>
                      ...
                      <div className="row p-3">
                        <div className="col-12">
                          <Card
                            title="Start Typing Student Name"
                            textColor="black"
                          >
                            <div className="row p-2">
                              <div className="col-12 mb-3">
                                <Input
                                  type="text"
                                  placeholder="Enter the Student name to filter the list"
                                  onKeyUp={(e) => {
                                    if (e.target.value) {
                                  ...
                                  {filterEmployeeList.length === 0 && (
                                    <div className="p-5 text-center">
                                      <b className="text-danger">
                                        No Students Available : Consider
                                        Creating One !!
                                      </b>
                                    </div>
                                  )}
